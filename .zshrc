...
ZSH_AUTOSUGGEST_HIGHLIGHT_STYLE="fg=#ff4e40,underline"
...
alias aus="cd ~/Documents/AUS/"
alias mars="java -Dsun.java2d.uiScale=1.5 -Dawt.useSystemAAFontSettings=on -Dswing.aatext=true -jar ~/Mars4_5_1_1Unofficial.jar"
alias nn="cd ~/.config/nvim/"
alias b="cd .."
alias bb="cd ../.."
alias vi="nvim"
alias viz="nvim ~/dotfiles/.zshrc && source ~/.zshrc"
alias vik="nvim ~/dotfiles/.config/kitty/kitty.conf"
alias vig="nvim ~/dotfiles/.config/ghostty/config"
alias ff="fastfetch"
